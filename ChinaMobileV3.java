package org.emergency.app.backstage.controllernew.loanService.loan.tongdun;
...
public class ChinaMobileV3 {
    ...
    public static void chinaMobileV3(String city, String basicInfo, String accountPasswd) throws IOException {
		//partner_code: xiongmaoyd 
		//partner_key: 1285a95c70bd4079803dc751a90d56b3
        ...
        while (true) {
            if (code == 0 || !(code == 100 || code == 105 || code == 101 || code == 123 || code == 137 || code == 2007)) {
                break;
            }
            ...
            switch (code) {
                ...
                case 100:
                    ...
                    //发送请求
                    queryResult = HttpUtils.executeHttpPost(crawlAddr, queryParam, headers, accountPasswd + "&task_id=" + taskId + "&task_stage=INIT" + "&request_type=query");
                    //获取返回code
                    code = JSON.parseObject(queryResult).getInteger("code");
                    break;
                case 137:
    ...
    public static void main(String[] args){
        String city = "黑龙江移动";
        String basicInfo = "channel_code=100000&channel_type=YYS&real_name=&identity_code=&user_mobile=15846586139";
        String accountPwd = "user_name=&user_pass=";
